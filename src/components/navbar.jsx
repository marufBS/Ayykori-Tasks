...
//                     className="inline-flex justify-center items-center p-2 w-10 h-10 rounded-lg md:hidden hover:shadow text-emerald-300 hover:bg-emerald-100 " aria-controls="navbar-default" aria-expanded="false">
